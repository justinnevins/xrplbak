...
4. Read the Files block. `complete` means the bytes match the original. `INCOMPLETE` means the bundle was missing or partial; the "Before starting the server" list says what to re-enter.
